...
module div_unsigned(
    ...
    wire [31:0] quot = (divisor_r == 32'b0) ? 32'hFFFF_FFFF : (dividend_r / divisor_r);
    wire [31:0] rem  = (divisor_r == 32'b0) ? dividend_r    : (dividend_r % divisor_r);
