...
#
# Script generated by Vivado on Thu Jan 29 01:18:03 +0800 2026
...
export RDI_DATADIR="I:/vivado2024/Vivado/2024.2/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "inst_ram.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L dist_mem_gen_v8_0_15 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot inst_ram xil_defaultlib.inst_ram xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="I:/vivado2024/Vivado/2024.2/data/xsim"
  fi
